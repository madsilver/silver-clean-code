...
func (c *TransactionController) FindTransactionByID(ctx core.ContextServer) error {
...
func (c *TransactionController) FindTransactions(ctx core.ContextServer) error {
...
func (c *TransactionController) CreateTransaction(ctx core.ContextServer) error {
